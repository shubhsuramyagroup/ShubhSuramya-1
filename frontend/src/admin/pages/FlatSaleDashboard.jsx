...
/* ═══════════════════════════════════════════════════════════════════════════
   NAVBAR — Logo + Email + Logout only (no tab navigation)
═══════════════════════════════════════════════════════════════════════════ */
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 20px" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 56 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
            ...
            <img src={logo1} alt="logo text" style={{ height: 40, objectFit: "contain" }} />
          </div>

          {/* Right: email pill + logout */}
...
export default function App() {
  ...
  useEffect(() => {
  const saleSession = localStorage.getItem("sale");
  ...
  const session = JSON.parse(saleSession);
...
function handleLogout() {
  ...
  function handleDeleteConfirm() {
    ...
    if (deleteModal.type === "flatSale") confirmDeleteFlatSale(deleteModal.item);
  }
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg, fontFamily: "'DM Sans', sans-serif" }}>
      ...
      {/* Simplified Navbar — no tab navigation */}
      ...
      <main style={{ maxWidth: 1280, margin: "0 auto", padding: "24px 20px 60px" }}>
        {loading ? (
          ...
          /* Flat Sales shown directly — no tab click needed */
          <FlatSalesTab
            flatSales={flatSales}
      ...
      {deleteModal && (
        <DeleteConfirmModal
          ...
          name={deleteModal.type === "flatSale" ? deleteModal.item.customerName : deleteModal.item.name}
          invoiceNo={deleteModal.type === "flatSale" ? deleteModal.item.receiptNo : undefined}
